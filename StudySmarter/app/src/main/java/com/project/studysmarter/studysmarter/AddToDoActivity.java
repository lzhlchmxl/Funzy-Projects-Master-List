...
public class AddToDoActivity extends AppCompatActivity implements  DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    private String mUserEnteredCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserEnteredCategory = mUserToDoItem.getCategory();
        ...
        mCategoryEditText = (EditText)findViewById(R.id.category);
        ...
        mContainerLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hideKeyboard(mCategoryEditText);
            }
        });
        ...
        mCategoryEditText.setText(mUserEnteredCategory);
        mToDoTextBodyEditText.setText(mUserEnteredText);
        InputMethodManager imm = (InputMethodManager)this.getSystemService(INPUT_METHOD_SERVICE);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
        mCategoryEditText.setSelection(mCategoryEditText.length());
        ...
        mCategoryEditText.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserEnteredCategory = s.toString();
        ...
        mToDoSendFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if (mToDoTextBodyEditText.length() <= 0){
                ...
                } else if (mCategoryEditText.length() <= 0){
                   mCategoryEditText.setError("Please enter a course");
               }
    ...
    public void makeResult(int result){
        ...
        if(mUserEnteredCategory.length()>0) {
            String capitalizedString = Character.toUpperCase(mUserEnteredCategory.charAt(0))+mUserEnteredCategory.substring(1);
            mUserToDoItem.setCategory(capitalizedString);
        } else{
            mUserToDoItem.setCategory(mUserEnteredCategory);
        }
